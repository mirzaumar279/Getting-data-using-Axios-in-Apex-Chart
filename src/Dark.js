...
function Dark() {
  ...
  return (
    <div className="body1">
    <div className="bot">
      <header className="vvv">
        <Container>
          <Row>
            <Col>
              <span className="i22 mmm">
                <i className="fa-solid fa-house-chimney i11"></i>
              </span>
            </Col>
            <Col>
              <span className="tttt mmm">CHAIRMAN</span>
            </Col>
            <Col>
              <span className="tttt mmm">DASHBOARD</span>
            </Col>
            <Col>
              <form className="item">
                <input
                  className="searchh mmm"
                  type="search"
                  placeholder="Search"
                />
              </form>
            ...
            {/* <Col>
              <span className="bbt"><span className="ss">Click</span></span>
            </Col> */}
            <Col>
            <Link to="/" className="i33 mmmm">
              <span >
              <i class="fa-solid fa-sun i44"></i>
              </span>
              </Link>
            </Col>
            <Col>
              <span className="i33 mmmm">
                <i className="fa-sharp fa-solid fa-bell i44"></i>
              </span>
            </Col>
          </Row>
        </Container>
      ...
      <Row>
        <Col>
          <Container>
            <table striped bordered hover size="sm" className="table table-bordered bot14">
              <thead className="th">
                <tr>
                  <td>Department</td>
                  <td>Employees</td>
          ...
          <Col>
            <div className="bb" id="divi">
              <Col className="box4" colSpan={10}>
                <span className="boxxx">Overall Year Sale Summary</span>
              </Col>
      ...
      <Row>
        <Col>
          <Container>
            <table striped bordered hover size="sm" className="bot14 table table-bordered">
              <thead className="th">
                <tr>
                  <td>Location</td>
                  <td>City</td>
